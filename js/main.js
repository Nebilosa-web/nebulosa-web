...
let menuBtn = d.querySelector('.menu__btn')
let menuBtnClose = d.querySelector('.menu__btn-close')

menuBtn.addEventListener('click', e => {
  d.querySelector('.menu__sidenav').style.width = '60%';
  d.body.style.backgroundColor = 'rgba(0,0,0,0.4)';
})

menuBtnClose.addEventListener('click', e => {
  d.querySelector('.menu__sidenav').style.width = '0%';
...
const menuScroll = () => {
  ...
  if (d.body.scrollTop > 5 || d.documentElement.scrollTop > 5) {
